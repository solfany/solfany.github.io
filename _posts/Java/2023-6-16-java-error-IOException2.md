...
try ~ catch 문은 예외가 발생하면 그 이후의 코드는 실행되지 않기 때문이다.
...
_(예: IOException, ClassNotFoundException)_
...
_(예: ArithmeticException, NullPointerException, IndexOutOfBoundsException)_
