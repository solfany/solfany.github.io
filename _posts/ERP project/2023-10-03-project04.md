...
import { cilCloudDownload } from "@coreuiicons";
...
<aside style="background-color: #d4e4e9; font-size: 0.4rem; border: 1px solid #000; padding: 10px; border-radius: 5px;">📍 기능 및 특징 설명
